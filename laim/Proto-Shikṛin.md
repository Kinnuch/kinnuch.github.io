...
强焦点动词表示强烈的**希求**、**预言**性质，并通常将时锁定在**远过去**，不过也可以表达不受时间干扰的**恒真格言**或**真理**。强焦点也将使动词带有**稳定**、**聚合**的倾向。强焦点要求词干后附加\*-r/-l（来自√REL “单焦点”）。

对于**强词根**，范式为√(s)CV(C)(C) > √(s)CH̩(C)(C)←V。

| ∅-√GOL-w-∅-ei > ∅-√GH̩L-w-∅-ei-r←O+√HŌT |
| :------------------------------------: |
|            *gh̩lweir *o-hōt.            |
| ɪꜰ-snow.ꜱꜰ-3ꜱɢ.ɢᴅ-ᴇᴠ-ꜱᴛᴇᴍ-ꜱꜰ ᴠꜰʀᴄ꞊ᴍᴏᴅ. |
|          （渴望/预言）落雪。           |
...
| :----------------------------------------: |
|              *dōnmer *l-bāt.               |
|   ɪꜰ-prepare.ꜱꜰ-1ꜱɢ-ᴇᴠ-ꜱᴛᴇᴍ-ꜱꜰ ᴠꜰʀᴄ꞊ᴍᴏᴅ.   |
|       我爱做整理（并会一直爱下去）。       |

**弱焦点**

对于**强词根**，音节首会被复制一次并在前重复，原词首的**飘忽-s**在词中隐匿，即√(s)C{V/R}(C)(C) > √(s)
