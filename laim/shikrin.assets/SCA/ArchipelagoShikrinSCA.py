...
def execute_sca(word: str):
    # 加载输入文件
    categories = load_categories("ArchipelagoShikrinCategory.txt")
    replacements = load_replacements("ArchipelagoShikrinReplace.txt")
    rules = load_rules("ArchipelagoShikrinRule.txt", categories, replacements)
    debug_output = []
...
class DeadKeyHandler:
    ...
    debug = False  # True 时在控制台打印每次按键事件，便于核对 keysym
...
class ArchipelagoShikrinSCA:
    def __init__(self, root):
        self.root = root
        self.root.title("群岛希克林语音变工具")
    ...
    def create_widgets(self):
        tk.Label(self.root, text = "群岛希克林语音变", font = self.title_font).pack(pady = 10)
        ...
        self.tree = ttk.Treeview(
            steps_frame, 
            columns = ("PSkr", "PArSkr", "AArSkr", "OArSkr", "ArSkr", "Orth"),
            show = "headings",
            height = 1
        )
        ...
        self.tree.heading("PArSkr", text = "PArSkr")
        self.tree.heading("AArSkr", text = "AArSkr")
        self.tree.heading("OArSkr", text = "OArSkr")
        self.tree.heading("ArSkr", text = "ArSkr")
        self.tree.heading("Orth", text = "正字")
        
        # 设置列宽
        self.tree.column("PSkr", width = 100, anchor = "center")
        self.tree.column("PArSkr", width = 100, anchor = "center")
        self.tree.column("AArSkr", width = 100, anchor = "center")
        self.tree.column("OArSkr", width = 100, anchor = "center")
        self.tree.column("ArSkr", width = 100, anchor = "center")
...
if __name__ == "__main__":
    root = tk.Tk()
    app = ArchipelagoShikrinSCA(root)
    root.mainloop()